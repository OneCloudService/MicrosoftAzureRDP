...
echo IP:
tasklist | find /i "ngrok.exe" >Nul && curl -s localhost:4041/api/tunnels | jq -r .tunnels[0].public_url || echo "Failed to retreive NGROK authtoken - check again your authtoken"
